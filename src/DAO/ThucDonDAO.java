...
public class ThucDonDAO {
    ...
    public void addThucDon(ThucDon thucdon){
        ...
        conn = MyConnection.getMyConnection();
        String sql = "INSERT INTO thucdon(TenMon,MaNhom,DVTinh,DonGia,TrangThai) VALUE(?,?,?,?)";
        ...
        try{
            ...
            ps.setString(5, thucdon.getTrangthai());
    ...
    public void deleteThucDon(ThucDon thucdon){
        ...
        conn = MyConnection.getMyConnection();
        String sql = "update thucdon set TrangThai = ? WHERE MaMon = ?";
        
        try{
            ps = conn.prepareStatement(sql);
            ps.setInt(2, thucdon.getMamon());
            ps.setString(1, thucdon.getTrangthai());
