...
public class jp_GoiMon extends javax.swing.JPanel {
     ...
     * @param maban
     */
    public jp_GoiMon(String trangthai, String tenban, int maban) {
        initComponents();
        gm = this;
        TableCTHD();
        jlNhomMon();
                    ...
                    for (int i = 0; i < listTD.size(); i++) {
                        ...
                        pn[i].addMouseListener(new MouseAdapter() {
                            ...
                            public void mousePressed(MouseEvent e) {
                                jp_SoLuong sl = new jp_SoLuong(Run.tc, true, e.getComponent().getName(), TenBan, MaBan, dongia);
                                sl.setVisible(true);
                            }
                        });
                        jpThucDon.add(pn[i]);
