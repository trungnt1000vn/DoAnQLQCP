 ...
 * @author ThangIKCU
 */
public class jp_SoLuong extends javax.swing.JDialog {
     ...
     * @param MaHD
     */
    public jp_SoLuong(java.awt.Frame parent, boolean modal, String MaMon, String TenBan, int MaBan, float DonGia) {
        super(parent, modal);
        initComponents();
        mamon = MaMon;
        tenban = TenBan;
        ...
        dongia = DonGia;
        view();
        hd = hdDAO.GetHoaDonByMaBan(MaBan);
        if (hd != null) {
    ...
    private void btOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOKActionPerformed
        if (hd == null) {
            ...
            hd1.setMaban(maban);
            hd1.setTennv(Run.tc.lblTenNV.getText().toString());
            hdDAO.addHoaDon(hd1);
            hd = hdDAO.GetHoaDonByMaBan(maban);
            System.out.println(".mousePressed() " + hd.getMahd());
            if (cthd != null) {
        ...
        jp_GoiMon.gm.lblGioDen.setText("Giờ đến: " + df.format(hd.getGioden()));
        jp_GoiMon.gm.lblNV.setText("Người nhập: " + hd.getTennv());
        jp_GoiMon.gm.lblMaHD.setText(hd.getMahd());
        jp_GoiMon.gm.btDatBan.setVisible(false);
        jp_GoiMon.gm.btDong.setVisible(false);
        jp_GoiMon.gm.btThanhToan.setVisible(true);
        jp_GoiMon.gm.ModelCTHD.setRowCount(0);
        jp_GoiMon.gm.setDataCTHDtable(cthdDAO.getListCTHDbyMaHD(hd.getMahd()));
        jp_GoiMon.gm.lblTongTien();
